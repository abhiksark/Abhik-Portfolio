...
export const meta = {
  author: 'Abhik Sarkar',
  date: '2023-11-12',
  title: 'The Magic Behind 4A464946: How It Defines JPEG Files',
  description:
  ...
  keywords: ['magic numbers', 'JPEG files', '4A464946', 'file signatures', 'hexadecimal magic numbers', 'digital file formats']
}


export default (props) => <ArticleLayout meta={meta} {...props} />

# The Magic Behind 4A464946: How It Defines JPEG Files
